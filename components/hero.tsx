        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
              ...
              <span className="text-blue-600">QR Store</span>
            </h1>
            <p className="mt-3 text-lg text-gray-800 dark:text-neutral-400">
              By creating your own custom QR code, you can effortlessly enable
              thousands of people to access the links in your curated list. It's
              a simple yet powerful way to share content, drive engagement, and
              expand your reach. Enhance your digital presence with just one
              scan!
            </p>
